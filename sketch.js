...
function setup() {
	...
	//sling
	sling = new String(polygon.body,{x: 250,y: 250})
	...
	g1 = new Ground(1525,375,30,750);
	g2 = new Ground(5,375,20,750);
	g3 = new Ground(765,5,1530,20);
...
function draw() {
	...
	text("Hit the space bar to get a second chance ",800,680);
